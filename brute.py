...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: Nilkahis cyber           |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print Y+"  |             INSTAGRAM:nhill_03              |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |      Subscribe Channel Nilkahis Cyber       |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   HACK FACEBOOK BRO ^_^   •••••••••|"
    print GG+"  √=============================================√"

banner()

print wd+"         https://www.github.com/nilkahis-cyber "
...
def edit_wordlist():
        ...
        print GG+" "
        ed = str(raw_input("[?] Edit wordlist gak.? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
